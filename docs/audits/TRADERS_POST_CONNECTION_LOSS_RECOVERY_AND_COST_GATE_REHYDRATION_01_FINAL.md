...
- A final reread exposed a millisecond-scale false WAL/PITR readiness sample
  while the host ACK daemon atomically replaced its state file through the
  Windows bind mount. Readonly now retries only this volatile safe artifact
  three times at 10 ms intervals; persistent absence/corruption still fails
  closed. Six consecutive deployed readiness reads then returned
  WAL/PITR/mutation `true`.
...
```text
IMPLEMENTATION_COMMITS = 092d9940480a826fe26be1d950247c5fa4689946,2c819282b25fd2700921a0f1289fbf96557b2142,99192f5a46e3dc650054cf9a3b8a7039efa179ae,9a7667137f52af72d8d6fee1fd8d2610b0be3e36
...
READONLY_IMAGE = sha256:5fb72fac7bf3d78c5048726c7c178f9668184b22b6ebd62a6c6f047139952245
READONLY_SOURCE = 9a7667137f52af72d8d6fee1fd8d2610b0be3e36
...
FOCUSED_SERVER = 87_PASS_PLUS15_PASS_PLUS39_PASS_PLUS15_PASS_16_SKIPPED_PLUS18_WAL_OBSERVATION_PASS_PLUS1858_READONLY_PASS_2_SKIP
...
PAPER = CONTINUOUS_ARMED_GENERATION12_HEALTHY_CURRENT_MUTATION_READY_SIX_CONSECUTIVE_READS
