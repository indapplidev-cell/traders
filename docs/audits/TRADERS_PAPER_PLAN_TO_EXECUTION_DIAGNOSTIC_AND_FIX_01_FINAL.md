...
FINAL_VERDICT = CODE_RUNTIME_SCHEMA_WAL_PITR_DESKTOP_AND_FIRST_NATURAL_PLAN_TERMINAL_OUTCOME_PASS
...
## First natural post-deployment Plan PAPER acceptance

The first natural plan arrived without synthetic production stimulus and was
durably classified end-to-end. It was not replayed after expiry.

```text
NATURAL_PLAN_OBSERVED = YES
SYMBOL = SUIUSDT
PROFILE_ID = trade-5m-v1
UNIVERSE_ID = trading-universe-v2
BOUNDARY = 2026-09-01T16:20:00.000Z / 1788279600000
...
SELECTOR_CANDIDATE_ID = paper:production-approval-candidate:v1:4c054cbc9dce4ec224b5e2318a715d6567131871a82325da54ae9b2a87015407
...
FINAL_APPROVAL_ID = paper:risk-approval:v1:1d56d757049b5265a76fe037f39a7927627191157f6c4c282d5312a5009d9a06
PLAN_CREATED_AT = 2026-09-01T16:20:28.935Z
APPROVAL_VALID_UNTIL = 2026-09-01T16:24:59.999Z
CANONICAL_VALIDITY = NEXT_5M_BOUNDARY_MINUS_1MS_PASS
...
RUNTIME_DAEMON_SCHEDULER_MUTATION_AT_OBSERVATION = TRUE_TRUE_TRUE_TRUE
LIVE_AT_OBSERVATION = FALSE
ROOT_CAUSE_FOR_THIS_NATURAL_NON_EXECUTION = WAL_PITR_ACK_OWNER_WAS_NOT_CURRENT_DURING_THE_APPROVAL_WINDOW
NO_EXPIRED_REPLAY = PASS
READONLY_HISTORICAL_DRILLDOWN = PASS
POSTGRES_OUTCOME_COMMAND_POSITION = 1_0_0
```

The pre-fix Control readiness adapter collapsed any non-ready Readonly envelope
to all infrastructure booleans false. Consequently this historical row retained
an over-broad attempt diagnostic (`MARKET_DATA_NOT_READY`,
`APPROVAL_SOURCE_NOT_READY`, `WAL_NOT_READY`, `PITR_NOT_READY`,
`LIVE_NOT_DISABLED`) even though the authoritative safety fact was the stale
WAL ACK owner and LIVE remained disabled. The terminal lifecycle and expiry
reason were correct and durable, but the component diagnosis was imprecise.

That precision defect is fixed and deployed: Control now preserves independent
market-data, approval-source, WAL, PITR and LIVE facts and carries additional
Readonly denials as their exact machine codes. An extra denial short-circuits
before command ingestion and remains durable. The WAL daemon also now waits for
the asynchronous archive-command ACK settlement before publishing post-sync
backlog/pending counts.

```text
CONTROL_REASON_REGRESSION = 26_PASSED
WAL_ACK_REGRESSION = 7_PASSED
ISOLATED_POSTGRES16_E2E_FRESH = 5_PASSED
CONTROL_DEPLOYED_IMAGE = sha256:f747daa3b9b51228092aeaee849de7fd52a7a01ccaba58f7869b4374b63a8940
CONTROL_DEPLOYED_COMMIT = 5b5237c
CONTROL_RUNTIME = HEALTHY_RESTART0_ARMED_GENERATION6
WAL_ACK_RUNTIME = RUNNING_IDENTITY_MATCH_HEARTBEAT_HEALTHY_BACKLOG0_PENDING0
WAL_READY_AFTER = TRUE
PITR_READY_AFTER = TRUE
LIVE_STATE_AFTER = DISABLED
BINANCE_ORDER_API_CALLS_BY_TASK = 0
SECRET_OUTPUT = 0
NATURAL_VERIFICATION_HEARTBEAT = COMPLETE_STOPPED
```
