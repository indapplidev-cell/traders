...
from app.experiments.ml38_2_fv3_tuning_matrix import ML38_9_2_BASELINE_EDGE_CONFIG_IDS
...
def test_ml38_9_single_symbol_full_uses_baseline_edge_shortlist() -> None:
    ...
    assert all(config_id in ML38_9_2_BASELINE_EDGE_CONFIG_IDS for config_id in wrapper.selected_config_ids)
    assert all(config_id.endswith("_be") for config_id in wrapper.selected_config_ids)


def test_ml38_9_quick_quality_and_single_symbol_full_use_baseline_edge_shortlists() -> None:
