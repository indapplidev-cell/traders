...
from app.experiments.ml38_2_fv3_tuning_matrix import ML38_9_3_CALIBRATED_DECISION_CONFIG_IDS
...
def test_ml38_9_single_symbol_full_uses_calibrated_decision_shortlist() -> None:
    ...
    assert all(config_id in ML38_9_3_CALIBRATED_DECISION_CONFIG_IDS for config_id in wrapper.selected_config_ids)
    assert all(config_id.endswith("_cd") for config_id in wrapper.selected_config_ids)
