...
def test_ml38_9_single_symbol_full_uses_bias_aware_shortlist() -> None:
    ...
    assert all(config_id in ML38_9_1_BIAS_AWARE_CONFIG_IDS for config_id in wrapper.selected_config_ids)
    assert all(config_id.endswith("_ba") for config_id in wrapper.selected_config_ids)


def test_ml38_9_quick_quality_and_single_symbol_full_use_bias_aware_shortlists() -> None:
