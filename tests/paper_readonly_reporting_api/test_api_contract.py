    ...
    assert status == {
        ...
        "canary_open_position_limit": None, "canary_open_position_count": None,
            ...
            "authority_mode": "FIRST_CANARY_HISTORICAL",
                ...
                "budget_policy_source": None,
                "budget_enforcement_mode": None,
                "risk_per_trade_value": None,
                "risk_per_trade_unit": None,
                "risk_per_trade_source": None,
                "daily_loss_formula": None,
                "daily_risk_formula": None,
                "budget_day": None,
                "budget_reset_at": None,
                "daily_command_budget_value": None,
                "daily_command_budget_limit": None,
                "daily_command_budget_unit": None,
                "daily_command_budget_source": None,
                "daily_risk_used": None,
                "daily_risk_limit": None,
                "daily_risk_unit": None,
                "daily_risk_source": None,
                "daily_realized_loss_used": None,
                "daily_realized_loss_limit": None,
                "daily_realized_loss_unit": None,
                "daily_realized_loss_source": None,
                "loss_streak_used": None,
                "loss_streak_limit": None,
                "loss_streak_source": None,
                "risk_pause": None,
