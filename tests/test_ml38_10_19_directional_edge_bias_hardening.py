...
def test_ml38_10_19_grid_matrix_and_runtime_include_lv27_dirbias_configs() -> None:
    ...
    assert run_fv3_cached_tuning.FAST_DEBUG_CONFIGS[0].startswith("lv27_")
    assert run_fv3_cached_tuning.QUICK_QUALITY_CONFIGS[0].startswith("lv27_")
    assert len(run_fv3_cached_tuning.FAST_DEBUG_CONFIGS) == 7
    assert len(run_fv3_cached_tuning.QUICK_QUALITY_CONFIGS) == 13
