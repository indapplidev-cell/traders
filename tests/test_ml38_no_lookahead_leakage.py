...
def test_ml38_fv3_features_do_not_change_when_future_candle_mutates() -> None:
    ...
    base_features = builder.build(base_candles, symbol="BTCUSDT", interval="15m", feature_version="fv3_candle_ta_context")
    mutated_features = builder.build(mutated_candles, symbol="BTCUSDT", interval="15m", feature_version="fv3_candle_ta_context")
