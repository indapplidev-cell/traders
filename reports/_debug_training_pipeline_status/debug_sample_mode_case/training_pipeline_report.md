# Training Pipeline Report - debug_sample_mode_case

## Run

- run_id: `debug_sample_mode_case`
...
- training_pipeline.log: `reports\_debug_training_pipeline_status\debug_sample_mode_case\training_pipeline.log`
- training_pipeline_events.jsonl: `reports\_debug_training_pipeline_status\debug_sample_mode_case\training_pipeline_events.jsonl`
- training_pipeline_report.json: `reports\_debug_training_pipeline_status\debug_sample_mode_case\training_pipeline_report.json`
- training_pipeline_report.md: `reports\_debug_training_pipeline_status\debug_sample_mode_case\training_pipeline_report.md`
...
| `db_check` | `SKIPPED` | `0.00s` | Sample mode does not require DB access |
| `load_candles` | `COMPLETED` | `0.00s` | Sample long-history candle load simulated |
| `check_candle_gaps` | `COMPLETED` | `0.00s` | Sample candle gap check simulated |
| `build_features` | `COMPLETED` | `0.00s` | Sample feature build simulated |
| `build_labels` | `COMPLETED` | `0.00s` | Sample label build simulated |
| `build_dataset` | `COMPLETED` | `0.00s` | Sample dataset build simulated |
| `train_model` | `COMPLETED` | `0.00s` | Sample training simulated |
| `probability_diagnostics` | `COMPLETED` | `0.00s` | Sample probability diagnostics generated |
| `baseline_compare` | `COMPLETED` | `0.00s` | Sample baseline comparison generated |
| `calibration_diagnostics` | `COMPLETED` | `0.00s` | Sample calibration diagnostics generated |
| `profit_aware_evaluation` | `COMPLETED` | `0.00s` | Sample profit-aware evaluation generated |
| `walk_forward_evaluation` | `COMPLETED` | `0.00s` | Sample walk-forward evaluation generated |
