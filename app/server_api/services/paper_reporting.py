...
class PaperReadonlyReportingService:
    ...
    def readiness(self) -> PaperReadiness:
        ...
        return PaperReadiness(
            ...
            commission_status=runtime.commission_status,
            commission_snapshot_age_seconds=runtime.commission_snapshot_age_seconds,
            commission_last_attempt_at=runtime.commission_last_attempt_at,
            commission_last_success_at=runtime.commission_last_success_at,
            commission_next_retry_at=runtime.commission_next_retry_at,
            commission_failure_count=runtime.commission_failure_count,
            commission_last_error_code=runtime.commission_last_error_code,
            commission_symbols_ready=runtime.commission_symbols_ready,
            commission_symbols_expected=runtime.commission_symbols_expected,
            cost_model_ready=runtime.cost_model_ready,
            ...
            budget_policy_version=control.budget_policy_version,
            budget_policy_source=control.budget_policy_source,
            budget_enforcement_mode=control.budget_enforcement_mode,
            risk_per_trade_value=control.risk_per_trade_value,
            risk_per_trade_unit=control.risk_per_trade_unit,
            risk_per_trade_source=control.risk_per_trade_source,
            daily_loss_formula=control.daily_loss_formula,
            daily_risk_formula=control.daily_risk_formula,
            budget_day=control.budget_day,
            budget_reset_at=control.budget_reset_at,
            daily_command_budget_value=control.daily_command_budget_value,
            daily_command_budget_limit=control.daily_command_budget_limit,
            daily_command_budget_unit=control.daily_command_budget_unit,
            daily_command_budget_source=control.daily_command_budget_source,
            daily_risk_used=control.daily_risk_used,
            daily_risk_limit=control.daily_risk_limit,
            daily_risk_unit=control.daily_risk_unit,
            daily_risk_source=control.daily_risk_source,
            daily_realized_loss_used=control.daily_realized_loss_used,
            daily_realized_loss_limit=control.daily_realized_loss_limit,
            daily_realized_loss_unit=control.daily_realized_loss_unit,
            daily_realized_loss_source=control.daily_realized_loss_source,
            loss_streak_used=control.loss_streak_used,
            loss_streak_limit=control.loss_streak_limit,
            loss_streak_source=control.loss_streak_source,
            risk_pause=control.risk_pause,
    ...
    def runtime_status(self) -> PaperRuntimeStatus:
        from app.config.trading_config_manager import get_trading_config_manager
        active = get_trading_config_manager().get_active_snapshot().resolved
        value = self._runtime()
