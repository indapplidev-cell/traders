...
PAPER_SCHEMA_MAXIMUM: Final = READONLY_SCHEMA_0028
...
def inspect_readonly_schema_capabilities(connection: Connection) -> ReadonlySchemaCapabilityResult:
    ...
    try:
        ...
        if revision in {
            ...
            READONLY_SCHEMA_0026, READONLY_SCHEMA_0027, READONLY_SCHEMA_0028,
        }:
            _validate_model(
        ...
        if revision in {
            ...
            READONLY_SCHEMA_0027, READONLY_SCHEMA_0028,
        }:
            for model in (
        ...
        if revision in {READONLY_SCHEMA_0027, READONLY_SCHEMA_0028}:
