            ...
            _validate_model(
                ...
                excluded=(
                    frozenset({
                        ...
                        "net_exit_pnl_current", "net_exit_pnl_currency",
                        "net_exit_pnl_quantized", "net_pnl_protection_window_active",
                        "net_pnl_protection_triggered", "net_pnl_protection_triggered_at",
                        "net_pnl_protection_1m_boundary", "exit_candidate_reason",
                        "exit_decision_reason", "exit_decision_at", "exit_fill_at",
