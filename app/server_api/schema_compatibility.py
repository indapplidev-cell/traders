...
READONLY_SCHEMA_0027: Final = "0027_scalping_profitability_integration"
READONLY_SCHEMA_0028: Final = "0028_scalping_profitability_grants"
READONLY_SCHEMA_0029: Final = "0029_stale_position_shadow"
READONLY_SCHEMA_0030: Final = "0030_paper_recovery_close"
...
PAPER_SCHEMA_MAXIMUM: Final = READONLY_SCHEMA_0032
...
def inspect_readonly_schema_capabilities(connection: Connection) -> ReadonlySchemaCapabilityResult:
    ...
    try:
        ...
        if revision not in {
            ...
            READONLY_SCHEMA_0028, READONLY_SCHEMA_0029, READONLY_SCHEMA_0030, READONLY_SCHEMA_0031, READONLY_SCHEMA_0032,
        }:
        ...
        if revision in {
            ...
            READONLY_SCHEMA_0026, READONLY_SCHEMA_0027, READONLY_SCHEMA_0028, READONLY_SCHEMA_0029, READONLY_SCHEMA_0030, READONLY_SCHEMA_0031, READONLY_SCHEMA_0032,
        }:
            _validate_model(
        ...
        if revision in {
            ...
            READONLY_SCHEMA_0027, READONLY_SCHEMA_0028, READONLY_SCHEMA_0029, READONLY_SCHEMA_0030, READONLY_SCHEMA_0031, READONLY_SCHEMA_0032,
        }:
            for model in (
        ...
        if revision in {READONLY_SCHEMA_0027, READONLY_SCHEMA_0028, READONLY_SCHEMA_0029, READONLY_SCHEMA_0030, READONLY_SCHEMA_0031, READONLY_SCHEMA_0032}:
        ...
        if revision in {READONLY_SCHEMA_0029, READONLY_SCHEMA_0030, READONLY_SCHEMA_0031, READONLY_SCHEMA_0032}:
            _validate_model(inspector, tables, ScalpingStalePositionShadowRecord, issues)
        if revision == READONLY_SCHEMA_0032:
            _validate_model(inspector, tables, ScalpingPositionHoldDecisionRecord, issues)
        actual_profiles = {}
...
__all__ = [
    ...
    "READONLY_SCHEMA_0031", "READONLY_SCHEMA_0032",
