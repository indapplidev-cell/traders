...
def build_export_record(
    ...
    *,
    ...
    math_fields = (
        ...
        "geometry_feasibility_result", "target_candidates_considered",
        ...
        "economic_input_source", "spread_source", "depth_impact_source",
        "fee_source", "connection_generation", "market_source_status",
        "fee_source_status", "book_source_status", "cost_model_status",
        "last_success_at", "last_failure_at", "recovered_at",
        "rehydration_duration_ms", "fee_watermark",
        "fee_authorization_valid_until", "cost_gate_decision",
        "cost_gate_reason", "geometry_status", "geometry_reason",
    ...
    return {
        ...
        "strategy": {
            ...
            "raw_component_values": strategy.get("raw_component_values"),
            "normalized_component_scores": strategy.get("normalized_component_scores"),
            "positive_contributions": strategy.get("positive_contributions"),
            "negative_penalties": strategy.get("negative_penalties"),
        ...
        "geometry": {
            ...
            "minimum_economically_valid_target_bps": diagnostic.get("minimum_economically_valid_target_bps"),
            "minimum_economically_valid_target_price": diagnostic.get("minimum_economically_valid_target_price"),
            "geometry_feasibility_result": diagnostic.get("geometry_feasibility_result"),
            ...
            "target_candidates_considered": diagnostic.get("target_candidates_considered"),
            "first_causal_target": diagnostic.get("first_causal_target"),
            "first_actionable_target": diagnostic.get("first_actionable_target"),
        ...
        "cost_economics": {
            ...
            "cost_model_version": diagnostic.get("cost_model_version"),
            "rr_policy_version": diagnostic.get("rr_policy_version"),
            "target_policy_version": diagnostic.get("target_policy_version"),
            "geometry_calculation_version": diagnostic.get("geometry_calculation_version"),
            "price_normalization_quantum": diagnostic.get("price_normalization_quantum"),
        },
        "rr_cohorts": {
