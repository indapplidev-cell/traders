...
def _downstream_trace(
    ...
    *,
    ...
    detail.update({
        ...
        "connection_generation": diagnostic.get("connection_generation"),
        "market_source_status": diagnostic.get("market_source_status"),
        "fee_source_status": diagnostic.get("fee_source_status"),
        "book_source_status": diagnostic.get("book_source_status"),
        "cost_model_status": diagnostic.get("cost_model_status"),
        "last_success_at": diagnostic.get("last_success_at"),
        "last_failure_at": diagnostic.get("last_failure_at"),
        "recovered_at": diagnostic.get("recovered_at"),
        "rehydration_duration_ms": diagnostic.get("rehydration_duration_ms"),
        "fee_watermark": diagnostic.get("fee_watermark"),
        "fee_authorization_valid_until": diagnostic.get(
