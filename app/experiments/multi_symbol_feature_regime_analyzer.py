...
class MultiSymbolFeatureRegimeAnalyzer:
    ...
    def analyze(
        ...
        return {
            ...
            "read_only_evaluator_payload_reproduction_audit": read_only_evaluator_payload_reproduction_audit,
            "evaluator_payload_source_audit": read_only_evaluator_payload_reproduction_audit.get("evaluator_payload_source_audit", {}),
            "payload_reproduction_board": read_only_evaluator_payload_reproduction_audit.get("payload_reproduction_board", []),
            "timestamp_payload_join_board": read_only_evaluator_payload_reproduction_audit.get("timestamp_payload_join_board", []),
            "reproduced_mask_value_summary": read_only_evaluator_payload_reproduction_audit.get("reproduced_mask_value_summary", {}),
            "cascade_readiness_after_reproduction": read_only_evaluator_payload_reproduction_audit.get("cascade_readiness_after_reproduction", {}),
            ...
            "read_only_test_only_mask_cascade_counts_audit": read_only_test_only_mask_cascade_counts_audit,
            "test_only_mask_input_summary": read_only_test_only_mask_cascade_counts_audit.get("test_only_mask_input_summary", {}),
            "test_only_mask_cascade_board": read_only_test_only_mask_cascade_counts_audit.get("test_only_mask_cascade_board", []),
            "test_only_mask_removed_breakdown": read_only_test_only_mask_cascade_counts_audit.get("test_only_mask_removed_breakdown", {}),
    ...
    def _symbol_result(cls, summary: dict[str, Any]) -> dict[str, Any]:
        ...
        for row in cls._as_list(summary.get("configs_ranked") or summary.get("ranking")):
            ...
            if fold_feature_summary:
                ...
                payload["conditional_regime_rule_counts_by_active_flag"] = cls._as_dict(
                    fold_feature_summary.get(
                ...
                payload["conditional_regime_rule_metric_logic"] = cls._as_dict(
                    fold_feature_summary.get("conditional_regime_rule_metric_logic")
                )
                payload["conditional_regime_rule_required_metric_failure_count"] = cls._as_dict(
                    fold_feature_summary.get(
