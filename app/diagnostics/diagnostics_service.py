...
class DiagnosticsService:
    ...
    def compare_models(
        ...
        model_results = []
        profit_reports = {report.get("model_version"): report for report in self._load_matching(list(self._reports_dir.glob("*.json")), "profit_eval_")}
        confidence_reports = {report.get("model_version"): report for report in self._load_matching(list(self._reports_dir.glob("*.json")), "confidence_eval_")}
        calibration_reports = {report.get("model_version"): report for report in self._load_matching(list(self._reports_dir.glob("*.json")), "calibration_eval_")}
        for row in model_rows:
            ...
            calibration_report = calibration_reports.get(row["model_version"])
        ...
        report = {
            ...
            "feature_version": feature_version,
            "label_version": label_version,
            "baseline_results": baseline_report["baselines"],
