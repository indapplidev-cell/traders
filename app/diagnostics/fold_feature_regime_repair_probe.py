    ...
    def _conditional_regime_rule_relaxation_probe_board(
        ...
        *,
        ...
        for rule_id in rule_ids:
            ...
            outcome_map = cls._as_dict(outcome_by_failure_count.get(rule_id))
            failed_1_outcome = cls._as_dict(outcome_map.get("failed_1"))
            failed_2_plus_outcome = cls._as_dict(outcome_map.get("failed_2_plus"))
