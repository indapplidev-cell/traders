...
def build_trading_criteria_snapshot(
    ...
    groups = {
        ...
        "risk_requirements": (
            ...
            _criterion("allowed_risk_levels", "risk_requirements", C.ENUM_ALLOWLIST,
                       sorted(paper.allowed_risk_levels),
                       "app.engine_paper.paper_config.PaperConfig.allowed_risk_levels"),
            _criterion("require_risk_pre_approved", "risk_requirements", C.BOOLEAN_GATE,
                       paper.require_risk_pre_approved,
                       "app.engine_paper.paper_config.PaperConfig.require_risk_pre_approved"),
            _criterion("require_execution_review", "risk_requirements", C.BOOLEAN_GATE,
                       paper.require_execution_review_flag,
                       "app.engine_paper.paper_config.PaperConfig.require_execution_review_flag"),
            ...
            _criterion("max_preapprovals_per_symbol_day", "risk_requirements", C.FIXED_THRESHOLD,
                       risk.max_research_preapprovals_per_symbol_per_day,
                       "app.engine_risk.risk_config.RiskConfig.max_research_preapprovals_per_symbol_per_day", "preapprovals_per_day"),
            _criterion("max_preapprovals_total_day", "risk_requirements", C.FIXED_THRESHOLD,
                       risk.max_research_preapprovals_total_per_day,
                       "app.engine_risk.risk_config.RiskConfig.max_research_preapprovals_total_per_day", "preapprovals_per_day"),
            _criterion("max_preapprovals_per_direction_day", "risk_requirements", C.FIXED_THRESHOLD,
                       risk.max_research_preapprovals_per_direction_per_day,
                       "app.engine_risk.risk_config.RiskConfig.max_research_preapprovals_per_direction_per_day", "preapprovals_per_day"),
        ...
        "stop_policy": (
            ...
            _criterion("default_stop_buffer", "stop_policy", C.FIXED_THRESHOLD,
                       paper.default_stop_buffer_pct * 100,
                       "app.engine_paper.paper_config.PaperConfig.default_stop_buffer_pct", "percent"),
        ...
        "target_policy": (
            ...
            _criterion("fallback_target_default_rr", "target_policy", C.NOT_APPLICABLE,
                       paper.default_target_rr,
                       "app.engine_paper.paper_config.PaperConfig.default_target_rr", "ratio"),
        ...
        "position_sizing_policy": (
            ...
            _criterion("balance_exposure_limit", "position_sizing_policy",
                       C.NOT_CONFIGURED_AS_FIXED_THRESHOLD, None,
                       "app.engine_paper.paper_approvals.PaperQuantityApproval"),
        ),
        ...
        "slippage_policy": (
            ...
            _criterion("fill_latency", "slippage_policy", C.FIXED_THRESHOLD,
                       ...
                       "closed_1m_candles"),
            _criterion("fill_price_source", "slippage_policy", C.ENUM_ALLOWLIST,
                       [fill.price_source.value],
                       "app.operator_control.production_executor._foundation_policy"),
            _criterion("intrabar_conflict_policy", "slippage_policy", C.ENUM_ALLOWLIST,
                       [fill.intrabar_conflict_policy.value],
                       "app.operator_control.production_executor._foundation_policy"),
            _criterion("partial_fill_enabled", "slippage_policy", C.BOOLEAN_GATE,
                       fill.partial_fill_enabled,
                       "app.operator_control.production_executor._foundation_policy"),
            _criterion("future_data_allowed", "slippage_policy", C.BOOLEAN_GATE,
                       fill.future_data_allowed,
                       "app.operator_control.production_executor._foundation_policy"),
        ),
        "approval_policy": (
