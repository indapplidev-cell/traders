...
STATUS_AS_OF_COMMIT = 41b6e39593f8ed39d9b8deaec934dea03345f78f
DOCUMENT_REVISION = SELF
DOCUMENT_COMMIT_RESOLUTION = git log -1 --format=%H -- online_trader.md

RECONCILED_AT_UTC = 2026-08-20T17:49:04Z
RECONCILED_BY_TASK = TRADERS_DESKTOP_FUNNEL_CURRENT_FRESHNESS_RUNTIME_REMEDIATION_02
FILES_CHANGED = docs/audits/TRADERS_DESKTOP_FUNNEL_CURRENT_FRESHNESS_RUNTIME_REMEDIATION_02_FINAL.md, FINAL_DECISION.md, online_trader.md

REMOTE_PRODUCTION_BASE_AT_RECONCILIATION = 74db6518d2a144fcf8814323c55e4224a71700e9
PUSH_STATE_AT_RECONCILIATION = NOT_PUSHED_LOCAL_COMMITS_PRESENT
STATUS_CONFIDENCE = PRODUCTION_5M_SHADOW_ACTIVE_EXACT_PARAMETER_ID_SINGLE_OWNER_POSTFIX_EXACT10_ZERO_TRADING_MUTATIONS_15M_CONTINUOUS_DESKTOP_CURRENT_FRESHNESS_RUNTIME_VISIBLE
...
API_RUNTIME_STATUS = READONLY_DUAL_SCHEMA_IMAGE03B69844_HEALTHY_ON0017_27_GET_0_WRITE_CATALOG2467D88A_PAPER_READY_CONTROL_HEALTHY_GENERATION6_LIVE_OFF
...
## Desktop funnel CURRENT freshness localization remediation

```text
TASK = TRADERS_DESKTOP_FUNNEL_CURRENT_FRESHNESS_RUNTIME_REMEDIATION_02
RESULT = PASS_SOURCE_RUNTIME_CACHE_AND_VISIBLE_GUI
SERVER_IMPLEMENTATION_COMMIT = 8958482a8533d9141dd0b731fc1f5f75eecbd747
RELATED_CLIENT_IMPLEMENTATION_COMMIT = 2a4aec04bb3555948c95a175f8262ec645676de9
PROJECT_STATE_AUDIT_COMMIT = 41b6e39593f8ed39d9b8deaec934dea03345f78f
ROOT_CAUSE = TRADING_FUNNEL_FRESHNESS_CURRENT_EMITTED_WITHOUT_market.data.CURRENT_CATALOG_KEY
RUNTIME_ROOT_CAUSE = SOURCE_FIX_NOT_DEPLOYED_OLD_SERVER_CATALOG_MATCHED_OLD_DESKTOP_LKG
SERVER_AUTHORITY = RU_ДАННЫЕ_АКТУАЛЬНЫ_EN_DATA_CURRENT
PUBLIC_CODE_DRIFT_GUARD = market.data.CURRENT_REGISTERED
CLIENT_BOOTSTRAP = REGENERATED_FROM_SERVER_CATALOG_VERSION_i18n-2467d88a8f9049d6
VISIBLE_15M = 15m_PIPE_DATA_CURRENT_RU_EN_PASS
VISIBLE_5M = 5m_PIPE_DATA_CURRENT_RU_EN_PASS
FOCUSED_SERVER_TESTS = 21_PASSED
FOCUSED_CLIENT_TESTS = 21_PASSED
FULL_CLIENT_REGRESSION = 1450_PASSED_2_SKIPPED_3029_SUBTESTS_ONE_NONBLOCKING_TK_FINALIZER_WARNING
COMPILE = SERVER_PASS_CLIENT_PASS
PRODUCTION_DEPLOYMENT = READONLY_ONLY_IMAGE03B69844_HEALTHY_CATALOG2467D88A
DESKTOP_RUNTIME = NEW_PID15980_CACHE2467D88A_15M_AND_5M_VISIBLE_PASS
...
The text below the trade-profile selector is the funnel freshness context, not
the trading-mode runtime state. The first source-only attempt did not alter the
running API, whose old catalog matched the desktop's old LKG. The Readonly-only
redeployment and desktop restart now prove both profiles render `CURRENT`
without falling through to the generic unknown-state label.
