...
STATUS_AS_OF_COMMIT = 287626aa8027f05620333365d9f6755cc892e56f
DOCUMENT_REVISION = SELF
DOCUMENT_COMMIT_RESOLUTION = git log -1 --format=%H -- online_trader.md

RECONCILED_AT_UTC = 2026-09-05T23:09:03Z
RECONCILED_BY_TASK = TRADERS_DOCKER_DESKTOP_COLD_START_RUNTIME_RECOVERY_01
FILES_CHANGED = docs/audits/TRADERS_DOCKER_DESKTOP_COLD_START_RUNTIME_RECOVERY_01_FINAL.md, FINAL_DECISION.md, online_trader.md

REMOTE_PRODUCTION_BASE_AT_RECONCILIATION = 287626aa8027f05620333365d9f6755cc892e56f_ORIGIN_FEATURE_ENGINE_PLATFORM_PROJECTSTATE_PUSHED_5MIMAGE02B834E2_READONLY511472FC_OPERATOR8411DB7_SCHEMA0026
...
STATUS_CONFIDENCE = DOCKERENGINERECOVERED_5MCOLDSTARTFIXED_RUNNINGRESTART0_OWNERACQUIRED_FUNNEL5M15MHTTP200_GUIRUENF5AUTOREFRESHPASS_WALPITRTRUE_SCHEMA0026_CONTINUOUSARMED12_LIVEFALSE
...
API_RUNTIME_STATUS = DOCKERDESKTOPRECOVERED_SCALPINGV2_5MIMAGE02B834E2_SOURCECBF13A1_RUNNINGRESTART0_OWNERACQUIRED_OPERATOR8411DB7_READONLY511472F_HEALTHYRESTART0_SCHEMA0026_CONTINUOUSARMED12_WALPITRTRUE_OPEN0_LIVE_OFF_AT20260905T230903Z
SOURCE_API_STATUS = PAPEREXECUTIONFAILUREPROJECTION_ANDCAUSALWINDOWFIX_DEPLOYED_COHERENTDESKTOPSNAPSHOTWATCHDOGSINGLEFLIGHT_DESKTOP0E148D9
...
SECONDARY_BLOCKER = TRADERS_CLIENT_REMOTE_NOT_CONFIGURED; MOBILE_PREEXISTING_OVERLAPPING_DIRTY_WORKTREE_AND_NO_REMOTE
...
|---|---:|---|
| Online analytics/paper pipeline | Continuous PAPER plus 1m refinement SHADOW deployed | Scalping v2 remains the sole authority for new 5m decisions on schema 0026. The 1m module is entry-refinement-only, three natural shadow observations terminalized without duplicate commands, and AUTHORITATIVE promotion is blocked by inconclusive evidence |
...
| Readonly Server API | Healthy deployed schema-0026 image | Image `sha256:511472fc...`, source `cbf13a1...`, exposes refinement mode/state/reason, 1m reference, planned/refined/fill prices, and existing continuous lifecycle |
...
only active 5m `PRODUCTION_SEARCH` identity. Continuous PAPER generation 12 now
owns new v2 execution with durable UTC budgets and a global one-position cap.
Its first post-deployment natural cycle opened AVAXUSDT and remains OPEN at this
snapshot; closure was deliberately not forced. LIVE stays disabled.
