...
STATUS_AS_OF_COMMIT = 8958482a8533d9141dd0b731fc1f5f75eecbd747
DOCUMENT_REVISION = SELF
DOCUMENT_COMMIT_RESOLUTION = git log -1 --format=%H -- online_trader.md

RECONCILED_AT_UTC = 2026-08-20T17:34:07Z
RECONCILED_BY_TASK = TRADERS_DESKTOP_FUNNEL_CURRENT_FRESHNESS_I18N_REMEDIATION_01
FILES_CHANGED = app/i18n/catalog.py, app/i18n/public_codes.py, tests/server_api/test_i18n.py, online_trader.md

REMOTE_PRODUCTION_BASE_AT_RECONCILIATION = 74db6518d2a144fcf8814323c55e4224a71700e9
PUSH_STATE_AT_RECONCILIATION = NOT_PUSHED_LOCAL_COMMITS_PRESENT
STATUS_CONFIDENCE = PRODUCTION_5M_SHADOW_ACTIVE_EXACT_PARAMETER_ID_SINGLE_OWNER_POSTFIX_EXACT10_ZERO_TRADING_MUTATIONS_15M_CONTINUOUS
...
```text
TASK = TRADERS_DESKTOP_FUNNEL_CURRENT_FRESHNESS_I18N_REMEDIATION_01
RESULT = PASS_SOURCE_AND_GENERATED_CLIENT_BOOTSTRAP
...
the trading-mode runtime state. Both profiles now render the server-emitted
`CURRENT` value without falling through to the generic unknown-state label.
The change is source/client-artifact only and does not claim deployment.
