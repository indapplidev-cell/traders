...
STATUS_AS_OF_COMMIT = 4284b2a4301132a54b956c343666878536599051
DOCUMENT_REVISION = SELF
DOCUMENT_COMMIT_RESOLUTION = git log -1 --format=%H -- online_trader.md

RECONCILED_AT_UTC = 2026-08-25T05:08:36Z
RECONCILED_BY_TASK = TRADERS_DESKTOP_FUNNEL_ARBITRARY_RANGE_EXPORT_TIMEOUT_REMEDIATION_01
FILES_CHANGED = app/i18n/catalog.py, app/server_api/funnel_export.py, app/server_api/repositories/protocols.py, app/server_api/routes/v1.py, app/server_api/services/query_service.py, app/server_api/trading_funnel.py, tests/server_api/test_funnel_export.py, FINAL_DECISION.md, docs/audits/TRADERS_DESKTOP_FUNNEL_ARBITRARY_RANGE_EXPORT_TIMEOUT_REMEDIATION_01_FINAL.md, online_trader.md, ../traders-client/src/traders_client/api_contract/protocol.py, ../traders-client/src/traders_client/application/app_controller.py, ../traders-client/src/traders_client/funnel_export.py, ../traders-client/src/traders_client/i18n/generated_bootstrap.json, ../traders-client/src/traders_client/providers/mock_provider.py, ../traders-client/src/traders_client/providers/server_provider.py, ../traders-client/src/traders_client/ui/funnel_export_dialog.py, ../traders-client/src/traders_client/ui/main_window.py, ../traders-client/src/traders_client/ui/trading_funnel_view.py, ../traders-client/tests/test_funnel_export.py, ../traders-client/client_status.md, ../evidence_inbox/TRADERS_DESKTOP_FUNNEL_ARBITRARY_RANGE_EXPORT_TIMEOUT_REMEDIATION_01_FINAL.md

REMOTE_PRODUCTION_BASE_AT_RECONCILIATION = 74db6518d2a144fcf8814323c55e4224a71700e9
PUSH_STATE_AT_RECONCILIATION = NOT_PUSHED_LOCAL_COMMITS_PRESENT
STATUS_CONFIDENCE = ARBITRARY_FUNNEL_EXPORT_PASS_7D_19560_ROWS_99_PAGES_ZERO_TIMEOUTS_5M_CALIBRATION_OBSERVER_PRESERVED_133_OF144_EXACT10_SCHEMA0018_CANONICAL_WAL_PITR_PASS_CONTROL_GENERATION6_LIVE_OFF_NO_TUNING
...
API_RUNTIME_STATUS = READONLY_IMAGE4426AD3C_HEALTHY_RESTART0_SOURCE4D32DB3C_ON0018_28_GET_0_WRITE_1CPU_512MIB_CONTROL_IMAGEA4664FF5_HEALTHY_SOURCE9FE3A4F_GENERATION6_LIVE_OFF
...
```text
TASK = TRADERS_5M_SCALPING_PRODUCTION_OBSERVATION_AND_CALIBRATION_BASELINE_01
...
OBSERVATION_AT_RECONCILIATION = 133_OF144_BOUNDARIES_1330_OF1440_EVALUATIONS_EXACT10
...
AGGREGATION = FUNNEL_REASONS_SYMBOL_DIRECTION_GEOMETRY_COST_RR_COHORT_TEMPORAL_REGIME_SETUP_CHURN_QUOTA
CURRENT_OUTCOME = NO_SETUP90_ZERO_CANDIDATES_PLANS_APPROVALS_COMMANDS_POSITIONS
CONTINUITY = 5M_EXACT10_ZERO_DUPLICATES_15M_UNCHANGED
WAL_PITR = CANONICAL_PASS_PASS_ZERO_BACKLOG_PENDING_UNRESOLVED_NO_PHYSICAL_GAP
READONLY_WAL_PROJECTION = STALE_FALSE_FALSE_FAIL_CLOSED_OBSERVABILITY_DRIFT_NOT_CANONICAL
CONTROL_LIVE = ARMED_GENERATION6_UNCHANGED_LIVE_DISABLED
PRODUCTION_TUNING = ZERO
VALIDATION = CHANGED_PATHS_PASS_STALE_UNRELATED_HISTORICAL_DIFF_GUARD_CLASSIFIED
NEXT_ACTION = CONTINUE_SAME_TASK_UNTIL_144_BOUNDARIES_THEN_FINALIZE_CALIBRATION_BASELINE
```

The minimum observation duration has not elapsed, so this task is not marked
completed and no calibration recommendation has been issued. A hidden,
read-only waiter polls only the bounded distinct-boundary count; it has no
profile-owner, Control, PAPER, Binance order or LIVE authority. Older 5m rows
are excluded because they predate the final integrated runtime version.
...
```text
RECOMMENDED_NEXT_TASK = TRADERS_5M_SCALPING_PRODUCTION_OBSERVATION_AND_CALIBRATION_BASELINE_01
