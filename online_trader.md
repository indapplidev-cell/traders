...
STATUS_AS_OF_COMMIT = c93693d815d3951ce40676aa21dc35435e1d34ce
DOCUMENT_REVISION = SELF
DOCUMENT_COMMIT_RESOLUTION = git log -1 --format=%H -- online_trader.md

RECONCILED_AT_UTC = 2026-09-02T17:18:10Z
RECONCILED_BY_TASK = TRADERS_SCALPING_POLICY_INDEPENDENT_PROFILE_REDESIGN_01
FILES_CHANGED = app/engine_orchestrator/parallel_profiles.py, app/engine_orchestrator/pipeline_runner.py, app/engine_orchestrator/runtime_parameters.py, app/engine_orchestrator/trade_profile.py, app/engine_paper/production_approval.py, app/engine_paper/scalping_paper_runner.py, app/engine_paper/scalping_policy_v2.py, app/engine_paper/scalping_shadow.py, app/engine_risk/strategy_type_contract.py, app/engine_setup/setup_detector.py, app/engine_strategy/strategy_filter.py, app/operator_control/production_executor.py, app/server_api/funnel_export.py, app/server_api/routes/v1.py, app/server_api/schema_compatibility.py, app/server_api/schemas/models.py, app/server_api/trading_funnel.py, alembic/versions/0021_independent_scalping_profile_v2.py, scripts/calibrate_scalping_independent_profile.py, scripts/engine_orchestrator_online_pipeline.py, scripts/replay_scalping_v2_candles.py, tests/integration/paper_natural_execution_e2e/conftest.py, tests/integration/paper_natural_execution_e2e/test_natural_approval_opens_position.py, tests/test_scalping_independent_profile_v2.py, docs/audits/TRADERS_SCALPING_POLICY_INDEPENDENT_PROFILE_REDESIGN_01_REPLAY.json, docs/audits/TRADERS_SCALPING_POLICY_INDEPENDENT_PROFILE_REDESIGN_01_CANDLE_REPLAY.json, docs/audits/TRADERS_SCALPING_POLICY_INDEPENDENT_PROFILE_REDESIGN_01_FINAL.md, online_trader.md

REMOTE_PRODUCTION_BASE_AT_RECONCILIATION = be5b1cb14bdbb2654c8852271ceb6ab683f79a5c_ORIGIN_FEATURE_ENGINE_PLATFORM
PUSH_STATE_AT_RECONCILIATION = NOT_PUSHED_AHEAD22_BEHIND0
STATUS_CONFIDENCE = INDEPENDENT_SCALPINGV2_IMPLEMENTED_POSTGRESE2E8PASS_SCOPED1687PASS_15MFROZEN_NEGATIVE_CALIBRATION_VALIDATION_HOLDOUT_NOT_DEPLOYED_LIVEFALSE
...
API_RUNTIME_STATUS = READONLY_SOURCE7F9D08D_IMAGED6FA681E_HEALTHY_RESTART0_OPERATOR_CONTROL_SOURCE29380E7_IMAGE08250D80_HEALTHY_RESTART0_SCHEMA0020_RUNTIME_DAEMON_SCHEDULER_PAPER_MUTATION_TRUE_CONTROLARMED_GENERATION6_WALTRUE_PITRTRUE_LIVE_OFF
SOURCE_API_STATUS = PERSISTED_SELECTED_EXECUTION_LIFECYCLE_SHARED_BY_FUNNEL_AND_PAPER_READONLY_DESKTOP30E8A5A_CONSUMER_SYNCHRONIZED
CURRENT_STAGE = SCALPING_V2_NEW_CAUSAL_EDGE_REDESIGN_BEFORE_PAPER_DEPLOYMENT
CURRENT_BLOCKER = TRADE_5M_V2_NEGATIVE_CALIBRATION_VALIDATION_AND_HOLDOUT_ECONOMICS
CURRENT_PREREQUISITE = A_NEW_PRESPECIFIED_CAUSAL_EDGE_SOURCE_OR_SETUP_FAMILY_THAT_PASSES_LOCKED_COST_AWARE_OOS_GATES
SECONDARY_BLOCKER = NONE_COLLECTOR_RESTART_STORM_FIXED
BACKGROUND_TIMED_GATE = NATURAL_PAPER_OUTCOME_HEARTBEAT_COMPLETED_STOPPED_CONTROL_GENERATION6_LIVE_OFF
BACKGROUND_SCALPING_BLOCKER = TRADE_5M_V2_ZERO_OF576_CANDLE_REPLAY_CONFIGURATIONS_PROMOTABLE_HOLDOUT_EXPECTANCY_MINUS25_9001BPS_PF0_1210
```
...
RISK = 10BPS_PERTRADE_MAX2POSITIONS_MAX50BPS_OPENRISK_RESEARCH_PREAPPROVALS3PERSYMBOL6PERDIRECTION10PERDAY
